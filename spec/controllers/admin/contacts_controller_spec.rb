...
describe Admin::ContactsController do
  ...
  it "show action should render show template" do
    get :show, :id => Factory.create(:valid_contact)
  ...
  it "edit action should render edit template" do
    get :edit, :id => Factory.create(:valid_contact)
    response.should render_template(:edit)
  end
  
  it "update action should render edit template when model is invalid" do
    c = Factory.create(:invalid_contact)
    Contact.any_instance.stubs(:valid?).returns(false)
    put :update, :id => c
    response.should render_template(:edit)
  end
  ...
  it "update action should redirect when model is valid" do
    Contact.any_instance.stubs(:valid?).returns(true)
    put :update, :id => Factory.create(:valid_contact)
    response.should redirect_to(admin_contact_url(assigns[:contact]))
  end
  
  it "destroy action should destroy model and redirect to index action" do
    contact = Factory.create(:valid_contact)
